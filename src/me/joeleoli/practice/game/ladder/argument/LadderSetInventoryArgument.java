...
public class LadderSetInventoryArgument extends PluginCommandArgument {
    ...
    public void onCommand(CommandSender sender, String[] args) throws CommandException {
        ...
        ManagerHandler.getLadderManager().getLadders().get(args[1]).setDefaultInventory(InventoryUtils.playerInventoryFromPlayer(player));
