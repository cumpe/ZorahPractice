...
public class LadderSetHitDelayArgument extends PluginCommandArgument {
    ...
    public void onCommand(CommandSender sender, String[] args) throws CommandException {
        ...
        if (!args[2].chars().allMatch(Character::isDigit)) {
            throw new CommandException(Collections.singletonList("That value only accepts digits."));
        }

        ManagerHandler.getLadderManager().getLadders().get(args[1]).setHitDelay(Integer.valueOf(args[2]));
