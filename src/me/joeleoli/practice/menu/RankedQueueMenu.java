...
public class RankedQueueMenu {
    ...
    public static void open(Player player) {
        ...
        Inventory inv = Bukkit.createInventory(null, ManagerHandler.getLadderManager().getLadderAmount(), ChatColor.GREEN + "Ranked Queue");
